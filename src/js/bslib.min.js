...
(document.documentElement.clientLeft||0),y:(window.pageYOffset||document.documentElement.scrollTop)-(document.documentElement.clientTop||0)}};setInterval(function(){e&&(e=!1,void 0!==d&&d(f))},20);c.addEventListener("DOMMouseScroll",g,{passive:!0});c.onmousewheel=c.onwheel=c.onscroll=g},mouseup:function(a,b){null!==a&&a.addEventListener("mouseup",function(a){void 0!==b&&b(a)},{passive:!0})},mousedown:function(a,b){null!==a&&a.addEventListener("mousedown",function(a){void 0!==b&&b(a)},{passive:!0})},
mousedownRight:function(a,b){null!==a&&a.addEventListener("contextmenu",function(a){a.preventDefault();void 0!==b&&b(a);return!1},{passive:!0})},keyup:function(a){window.addEventListener("keyup",function(b){void 0!==a&&a(b)},{passive:!0})},keydown:function(a){window.addEventListener("keydown",function(b){void 0!==a&&a(b)},{passive:!0})},input:function(a,b){function c(a){a=f.utils.combine(a,d);void 0!==b&&b(a)}var d={};window.addEventListener("keydown",function(a){d={altKey:a.altKey,ctrlKey:a.ctrlKey,
keyCode:a.keyCode,keyIdentifier:a.keyIdentifier,shiftKey:a.shiftKey,type:a.type}},!1);a.addEventListener("input",c,{passive:!0});a.addEventListener("change",c,{passive:!0})}},Paginate:function(a){function b(){e=e>=d.images.length?0:parseInt(f.data.getURLParameters()[d.id],10)||0;f.data.setURLParameters(d.id,e);h.src=d.images[e];return e}function c(){e=parseInt(f.data.getURLParameters()[d.id],10);if(e+1>=d.images.length&&"string"===typeof d.lastClickDestination)document.location.href=d.lastClickDestination;
else{var a=e+1<d.images.length?e+1:d.loop?0:e;f.data.setURLParameters(d.id,a);h.src=d.images[a]}return e}var d=f.utils.combine({id:"bs-page",images:[],loop:!0},a),e=parseInt(f.data.getURLParameters()[d.id],10)||0,h=document.getElementById(d.id);(function(){h.addEventListener("click",function(a){c(a)});b(event)})();return{update:b,next:c}},utils:{map:function(a,b,c,d,e){return d+(a-b)/(c-b)*(e-d)},combine:function(a,b){if("Array"===Object.prototype.toString.call(b).split(/\W/)[2])b=b.reduce(function(a,
b){a.push(b);return a},a);else for(var c in a)b[c]=void 0!==b[c]?b[c]:a[c];return b},shuffleArray:function(a){for(var b=[],c=a.length;c--;b.unshift(a[c]));var d,e;for(a=b.length;a;d=parseInt(Math.random()*a),e=b[--a],b[a]=b[d],b[d]=e);return b},removeArrayDuplicates:function(a){var b=[];if("Array"===Object.prototype.toString.call(a).split(/\W/)[2])return a.reduce(function(a,b){-1===a.indexOf(b)&&a.push(b);return a},b)},generateString:function(a){a=a||36;for(var b="";b.length<a;b+=Math.random().toString(36).substr(2));
return b.substr(0,a)}}};("undefined"!==typeof global&&null!==global?global:this).bs=f}).call(this);
